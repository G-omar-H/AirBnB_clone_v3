...
class TestStateDocs(unittest.TestCase):
    ...
    def test_state_module_docstring_app(self):
        ...
        self.assertIsNot(app.__doc__, None, "state.py needs a docstring")
        self.assertTrue(len(app.__doc__) >= 1, "state.py needs a docstring")
    ...
    def test_state_class_docstring_users(self):
        """Test for the State class docstring"""
        self.assertIsNot(users.__doc__, None, "State class needs a docstring")
